          ...
          <>
            ...
            <div className="rounded-lg border border-zinc-200 bg-white p-4 dark:border-zinc-800 dark:bg-zinc-900">
              <div className="mb-3 flex items-center justify-between">
                ...
                >
                  <option value="aht">Среднее время обработки</option>
                  <option value="call_volume">Объём звонков</option>
                  <option value="avg_script_score">Соблюдение скрипта</option>
                </select>
              </div>
              {trend && (
                <TrendChart
